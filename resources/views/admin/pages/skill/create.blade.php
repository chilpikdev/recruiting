...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route("admin.skills.index") }}">Навыки</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="@if(isset($data)) {{ route('admin.skills.update', $data->id) }} @else {{ route('admin.skills.store') }} @endif" method="POST">
                @csrf
                @if (isset($data))
                    @method("PUT")
                @endif
